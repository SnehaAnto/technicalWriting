\ifthenelse{\equal{\CoverOption}{classic}}{
    ...
    \vfill
    \centering
    \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{Figures/Theme/blue_fg.jpg}%
    \vfill
    }}}
}{
    \newcommand\BackgroundPicCover{%
...
\begin{titlepage}
    ...
    \ifthenelse{\equal{\CoverOption}{classic}}{
        \ifthenelse{\equal{\SchoolOption}{estg}}{
            \begin{figure}
                \includegraphics[width=0.485\linewidth]{Figures/Theme/Logotypes/CU_W_logo.png}
            \end{figure}
        }{}
